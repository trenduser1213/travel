...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Okt 2022 pada 14.20
...
CREATE TABLE `about` (
  ...
  `submotto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `teks_sejajar_video` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `teks_di_bawah_video` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `category_posts` (`id`, `nama`, `slug`, `created_at`, `updated_at`) VALUES
(1, 'Saudi', 'saudi', NULL, NULL),
(2, 'Tour Internasional', 'tour-internasional', NULL, NULL),
(3, 'Umroh', 'umroh', NULL, NULL),
(4, 'Haji', 'haji', NULL, NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `data_jamaahs`
--

CREATE TABLE `data_jamaahs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `foto_vaksin` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `pembiayaan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `setoran_awal` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mitra_marketing` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data untuk tabel `data_jamaahs`
--

INSERT INTO `data_jamaahs` (`id`, `nama`, `jeniskelamin`, `HP`, `email`, `NIK`, `no_paspor`, `foto_KTP`, `foto_vaksin`, `provinsi`, `kabupaten`, `kecamatan`, `alamat`, `slug_produk`, `pembiayaan`, `setoran_awal`, `mitra_marketing`, `created_at`, `updated_at`) VALUES
(1, 'Exercitationem rerum', 'perempuan', '+1 (935) 988-6255', 'hytiz@mailinator.com', '1234567890123456', 'Anim voluptas et cor', 'C:\\Users\\Lenovo\\AppData\\Local\\Temp\\php46DE.tmp', 'C:\\Users\\Lenovo\\AppData\\Local\\Temp\\php46DF.tmp', '11', '7412', '7204071', 'Qui quia aut possimu', 'paket-milad-2', 'Cash', '73', 'tvRis', NULL, NULL);
...
CREATE TABLE `galeri` (
  ...
  `kategori_galeri` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `galeri` (`id`, `judul`, `link`, `kategori_galeri`) VALUES
(1, 'Manasik', 'assets/images/gallery/Manasik-Safari-Tour.jpg', 'foto'),
(2, 'Pembekalan', 'assets/images/gallery/Pembekalan-Sebelum-Keberang.jpg', 'foto'),
(3, 'Proses Bagasi', 'assets/images/gallery/Proses-Bagasi.jpg', 'foto'),
(4, 'Belanja di Kebun Kurma', '<iframe src=\"https://www.youtube.com/embed/RX5ypX1TigY\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>', 'video'),
(5, 'Makam Baqeeq', '<iframe src=\"https://www.youtube.com/embed/kPgRkIXSFJs\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>', 'video'),
(6, 'Halal Bi Halal', '<iframe src=\"https://www.youtube.com/embed/HDASx9ovpC8\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>', 'video');

-- --------------------------------------------------------

--
-- Struktur dari tabel `identitas_perusahaans`
--

CREATE TABLE `identitas_perusahaans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_gedung_kantor` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alamat` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `no_hp_1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `no_hp_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_telepon_1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `no_telepon_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_pada_rekening` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `no_rekening_1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `no_rekening_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_rekening_3` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_rekening_4` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data untuk tabel `identitas_perusahaans`
--

INSERT INTO `identitas_perusahaans` (`id`, `nama`, `nama_gedung_kantor`, `alamat`, `no_hp_1`, `no_hp_2`, `no_telepon_1`, `no_telepon_2`, `email`, `nama_pada_rekening`, `no_rekening_1`, `no_rekening_2`, `no_rekening_3`, `no_rekening_4`, `facebook`, `instagram`, `youtube`, `created_at`, `updated_at`) VALUES
(1, 'PT. Safari Global Perkasa', 'Trillium Office and Residence', 'Jl. Pemuda 108 - 116 Lt. 1 No. 07, Surabaya', '081232324112', NULL, '+6231 51169000', '+6231 51168921', 'safariglobalperkasa.pt@gmail.com', 'PT. Safari Global Perkasa', 'BCA : 152 039 523 3 (IDR/RUPIAH)', 'MANDIRI :\n            142 00 22 33 44 51 (IDR/RUPIAH)\n            142 002 22 33 455 (USD/DOLLAR)\n            ', 'BSM : 716 117 161 6', NULL, 'https://www.facebook.com/safari.umrahhaji.9', 'https://www.instagram.com/safariumrahhaji/?hl=id', 'https://www.youtube.com/channel/UCXBQZ6LwqpGEOBggGBFpLqg', NULL, NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `kontak_jamaahs`
--

CREATE TABLE `kontak_jamaahs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(7, '2017_05_02_140432_create_provinces_tables', 1),
(8, '2017_05_02_140444_create_regencies_tables', 1),
(9, '2017_05_02_142019_create_districts_tables', 1),
(10, '2017_05_02_143454_create_villages_tables', 1),
(11, '2019_08_19_000000_create_failed_jobs_table', 1),
(12, '2019_12_14_000001_create_personal_access_tokens_table', 1),
(13, '2022_09_13_091651_about', 1),
(14, '2022_09_15_153028_syarat_migration', 1),
(15, '2022_09_16_001610_produk', 1),
(16, '2022_09_16_001651_gallery', 1),
(17, '2022_09_16_001721_artikel', 1),
(18, '2022_09_16_001732_kategori_artikel', 1),
(19, '2022_09_21_075105_create_posts_table', 1),
(20, '2022_09_21_122855_create_category_posts_table', 1),
(21, '2022_09_23_141650_create_kontak_jamaahs_table', 1),
(22, '2022_09_24_023837_create_identitas_perusahaans_table', 1),
(23, '2022_09_25_051706_create_data_jamaahs_table', 1),
(24, '2022_09_28_132124_create_mitra_marketings_table', 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `mitra_marketings`
--

CREATE TABLE `mitra_marketings` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data untuk tabel `mitra_marketings`
--

INSERT INTO `mitra_marketings` (`id`, `username`, `nama`, `hp`, `wa`, `alamat`, `kota`, `provinsi`, `jabatan`, `status`, `created_at`, `updated_at`) VALUES
(1, 'eU6y7', '', '', '', '', '', '', '', '', NULL, NULL),
(2, 'tvRis', 'Muhammad Asyhar', '081252397285', '6281252397285', 'Jl Karah 83 RT 1RW 06 Karah Jambangan', 'Surabaya', 'Jawa Timur', '', '1', NULL, NULL),
(3, 'liC1Q', 'Muhamad Arifin', '081234044195', '6281234044195', 'Jl Saidani Tambak Sumur Waru', 'Sidoarjo', 'Jawa Timur', '', '1', NULL, NULL),
(4, 'if5Oq', 'Novia Eka Agustin', '081259424480', '6281259424480', 'Perum Bumi Cabean Asri E32 Candi', 'Sidoarjo', 'Jawa Timur', '', '1', NULL, NULL),
(5, 'TRgGC', 'Erna Siswati', '081295741965', '6281295741965', 'Ngeni Permai Gang 212, Waru', 'Sidoarjo', 'Jawa Timur', '', '1', NULL, NULL),
(6, 'XIa3Z', 'ABDUL HADI', '082244556209', '6282244556209', 'JL Anyelir No 42 Tulungrejo', 'Kediri', 'Jawa Timur', '', '1', NULL, NULL),
(7, 'O6q4n', 'ABDULLAH WAHIB', '081232324112', '6281232324112', 'Jl Ngeni Permai 212', 'Sidoarjo', 'Jawa Timur', '', '1', NULL, NULL);
...
INSERT INTO `posts` (`id`, `category_post_id`, `gambar`, `judul`, `slug`, `kategori`, `written_by`, `excerpt`, `body`, `published_at`, `created_at`, `updated_at`) VALUES
(1, 1, 'assets/images/produk/2021-Milad-safari-tour.jpg', 'Paket Milad', 'paket-milad', 'saudi', 'M.Arifin', 'awkwkwkwkwkkw', 'akwkwdksndakansdknksadnksnksndknaskdnksndkasnd', '2022-09-30 08:39:03', NULL, NULL),
(2, 2, 'assets/images/produk/2021-Milad-safari-tour.jpg', 'Paket Milad2', 'paket-milad2', 'saudi', 'M.Arifin', 'awkwkwkwkwkkw', 'akwkwdksndakansdknksadnksnksndknaskdnksndkasnd', '2022-09-30 08:39:03', NULL, NULL),
(3, 3, 'assets/images/produk/2021-Milad-safari-tour.jpg', 'Paket Milad3', 'paket-milad3', 'saudi', 'M.Arifin', 'awkwkwkwkwkkw', 'akwkwdksndakansdknksadnksnksndknaskdnksndkasnd', '2022-09-30 08:39:03', NULL, NULL);
...
INSERT INTO `produks` (`id`, `nama`, `slug`, `gambar`, `harga`, `tgl_berangkat`, `durasi`, `total_seat`, `berangkat_dari`, `hotel`, `maskapai`, `created_at`, `updated_at`, `kategori_paket`) VALUES
(1, 'Paket Milad', 'paket-milad', 'assets/images/produk/2021-Milad-safari-tour.jpg', '30.000.000', '16 Sept 2022', '14 Hari', '75 Pax', 'Jakarta', 'Setaraf', 'Saudi Airlines', NULL, NULL, 'Umrah'),
(2, 'Paket Milad2', 'paket-milad-2', 'assets/images/produk/2021-Milad-safari-tour.jpg', '30.000.000', '16 Sept 2022', '14 Hari', '75 Pax', 'Jakarta', 'Setaraf', 'Saudi Airlines', NULL, NULL, 'Umrah'),
(3, 'Paket Milad3', 'paket-milad-3', 'assets/images/produk/2021-Milad-safari-tour.jpg', '30.000.000', '16 Sept 2022', '14 Hari', '75 Pax', 'Jakarta', 'Setaraf', 'Saudi Airlines', NULL, NULL, 'Haji');
...
--
-- Struktur dari tabel `syarat_dan_ketentuan`
--
...
ALTER TABLE `category_posts`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `category_posts_nama_unique` (`nama`),
  ADD UNIQUE KEY `category_posts_slug_unique` (`slug`);

--
-- Indeks untuk tabel `data_jamaahs`
--
ALTER TABLE `data_jamaahs`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `identitas_perusahaans`
--
ALTER TABLE `identitas_perusahaans`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `kontak_jamaahs`
--
ALTER TABLE `kontak_jamaahs`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `mitra_marketings`
--
ALTER TABLE `mitra_marketings`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `syarat_dan_ketentuan`
--
...
--
-- AUTO_INCREMENT untuk tabel `category_posts`
--
ALTER TABLE `category_posts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `data_jamaahs`
--
ALTER TABLE `data_jamaahs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT untuk tabel `identitas_perusahaans`
--
ALTER TABLE `identitas_perusahaans`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `kontak_jamaahs`
--
ALTER TABLE `kontak_jamaahs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `mitra_marketings`
--
ALTER TABLE `mitra_marketings`
...
--
-- AUTO_INCREMENT untuk tabel `syarat_dan_ketentuan`
--
ALTER TABLE `syarat_dan_ketentuan`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
