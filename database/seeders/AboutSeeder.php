...
class AboutSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('abouts')->insert([
            ...
            'link_video' => 'https://www.youtube.com/embed/HDASx9ovpC8',
        ...
        'teks_di_beranda'=> 'Keuntungan perusahaan ini sepenuhnya diinfaqkan untuk Pondok Pesantren Idhotun Nasyi in di Desa Sugihwaras, Kalitengah Lamongan Jawa Timur, sehingga dapat memberikan pendidikan gratis kepada para anak yatim dan kaum dhuafa.',
