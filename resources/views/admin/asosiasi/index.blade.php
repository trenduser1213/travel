            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('adminAsosiasi.create') }}" style="margin-left:auto"><button
                            ...
                            <tbody><?php $n = 1; ?>
                                @foreach ($asosiasi as $asosiasi)
                                    <tr>
                                        ...
                                        <td>{{ $asosiasi->nama }}</td>
                                        <td>
                                            <center><img src="{{ $asosiasi->logo }}" alt="{{ $asosiasi->nama }}"
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('adminAsosiasi.edit', $asosiasi->id) }}"><button
                                            ...
                                            <button class="btn btn-danger btn-sm" style="margin: 5px" data-toggle="modal"
                                                data-target="#ModalAsosiasiHapus-{{ $asosiasi->id }}">
                                                <span class="btn-label">
                                    ...
                                    <!-- Modal Hapus-->
                                    <div class="modal fade" id="ModalAsosiasiHapus-{{ $asosiasi->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header border-0">
                                                    <h5 class="modal-title">
                                                        Anda Yakin ingin menghapus asosiasi {{ $asosiasi->nama }}?
                                                    </h5>
                                                ...
                                                <div class="modal-footer border-0">
                                                    <button
                                                        onclick="hapusData('{{ route('adminAsosiasi.destroy', $asosiasi->id) }}')"
        ...
        function hapusData(url) {
            ...
            $.post(url, {
                ...
                .done((response) => {
                    ...
                    window.location.href = '/adminAsosiasi';
                })
                .fail((errors) => {
