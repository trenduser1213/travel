                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                                ...
                                <li>
                                    <div class="notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="{{ asset('assets/') }}../../admin-assets/assets/img/profile2.jpg"
                                                        alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                                    <span class="block">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="{{ asset('assets/') }}../../admin-assets/assets/img/profile.jpg"
                                    ...
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img
                                                    src="{{ asset('assets/') }}../../admin-assets/assets/img/profile.jpg"
