                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_tampil_di_halaman_produk" id="is_tampil_di_beranda" class="form-control"
                                    required>
                                    <option value="-" selected disabled>Pilih Opsi</option>
                                    <option value="ya">Ya</option>
                                    <option value="tidak">Tidak</option>
                            ...
                            <div class="form-group">
                                <label for="gambar">Poster Produk Sekarang</label>
                                <img src="" alt="">
                            </div>

                            <div class="form-group">
                                <label for="preview_lama">Poster Baru</label>
                                <input type="file"
