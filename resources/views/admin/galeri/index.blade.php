                    ...
                    <table id="tableVideo" class="table table-bordered table-striped">
                        ...
                        <tbody><?php $n = 1; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('adminGaleriVideo.edit', $video->id) }}"><button class="btn btn-success btn-sm" style="margin: 5px">
                                            <span class="btn-label">
                                                <i class="fa fa-edit" style="font-size:10px"></i>
                                            </span>
                                            Edit
                                        </button></a>
                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#ModalVideoHapus-{{ $video->id }}">
                                        <span class="btn-label">
                                            <i class="fa fa-trash" style="font-size:10px"></i>
                                        </span>
                                        Hapus
                            ...
                            <div class="modal fade" id="ModalVideoHapus-{{ $video->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer border-0">
                                            <button onclick="hapusData('{{ route('adminGaleriVideo.destroy', $video->id) }}')" type="" id="addRowButton" class="btn btn-primary">Hapus</button>
                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
                                        </div>
